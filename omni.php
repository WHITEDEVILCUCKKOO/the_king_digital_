...
<section class="omni">
    <div class="omni_content">
        <div class="omni_content--leftside">
            <button class="omni_content--input" onclick="searchWindow">
                <span>
        ...
        <div class="omni_content--main"></div>
        <div class="omni_content--rightside"></div>
    </div>
</section>
