...
<main class="contact-main">
    ...
    <section class="application_section">
        ...
        <section class="right_section_1 widh_wmob">
            ...
            <!-- section 1 overview -->
            <section id="overview_contect_box" class="section_sub_with">
                ...
                <div class="h8wh74523">
                    ...
                    <div class="uhujh2294sas">
                        <div class="aseh" style="padding: 15px 0">
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" width="30" fill="#197553"><path d="M224 32C241.7 32 256 46.3 256 64L256 160L384 160L384 64C384 46.3 398.3 32 416 32C433.7 32 448 46.3 448 64L448 160L512 160C529.7 160 544 174.3 544 192C544 209.7 529.7 224 512 224L512 288C512 383.1 442.8 462.1 352 477.3L352 544C352 561.7 337.7 576 320 576C302.3 576 288 561.7 288 544L288 477.3C197.2 462.1 128 383.1 128 288L128 224C110.3 224 96 209.7 96 192C96 174.3 110.3 160 128 160L192 160L192 64C192 46.3 206.3 32 224 32z"/></svg>
                            </span>
                        </div>
