    ...
    <section class="application_section">
        ...
        <section class="left_section_1" id="left_section_box">
            ...
            <ul class="top_nave_appli">
                <li class="subbox_link active" id="overview_btn_124" data-set="overview" onclick="show_this_box(this)">
                ...
                <li class="subbox_link" id="login_btn_124" data-set="login" onclick="show_this_box(this)">
                    <span class="svg_icon_box">
                ...
                <li class="subbox_link" id="dashbord_btn_124" data-set="dashbord" onclick="show_this_box(this)">
                    <span class="svg_icon_box">
            ...
            <div class="bottom_nave_apli">
                <h6>Channels</h6>
                <ul class="mosd82">
                    <li class="subbox_link" id="sms_btn_124" onclick="show_this_box(this)" data-set="sms">
                        <span class="svg_icon_box">
                    ...
                    <li class="subbox_link" id="rcs_btn_124" data-set="rcs" onclick="show_this_box(this)">
                    ...
                    <li class="subbox_link" id="whatsapp_btn_124" data-set="whatsapp" onclick="show_this_box(this)">
                    ...
                    <li class="subbox_link" id="voice_btn_124" data-set="voice" onclick="show_this_box(this)">
                    ...
                    <li class="subbox_link" id="ivr_btn_124" data-set="ivr" onclick="show_this_box(this)">
                    ...
                    <li class="subbox_link" id="click_to_call_btn_124" data-set="click_to_call" onclick="show_this_box(this)">
                        <span class="svg_icon_box">
                    ...
                    <li class="subbox_link" id="text_to_speech_btn_124" data-set="text_to_speech" onclick="show_this_box(this)">
                    ...
                    <li class="subbox_link" id="ai_agent_btn_124" data-set="ai_agent" onclick="show_this_box(this)">
            ...
            <h6>Utilities</h6>
            <ul class="top_nave_appli">
                <li class="subbox_link" id="journeys_btn_124" data-set="journeys" onclick="window.show_this_box(this)">
